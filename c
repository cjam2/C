<div id="formWrapper" style="border:1px solid #d0d0d0; padding:30px; max-width:750px; font-family:'Segoe UI', sans-serif; background:#fff; border-radius:8px;">
  <h2 style="margin-top:0; font-size:20px; color:#2e2e2e;">Service Request Form</h2>

  <!-- Dynamic form fields start here -->
  <div id="formFields">
    <!-- Field Template -->
    <div style="margin-bottom:15px; display:flex; align-items:center;">
      <label for="classification" style="flex:0 0 220px; font-weight:600;">Request Classification<span style="color:red;"> *</span></label>
      <select id="classification" class="required" style="flex:1; padding:8px; border:1px solid #ccc; border-radius:4px;">
    ...
    <div style="margin-bottom:15px; display:flex; align-items:center;">
      <label for="requestType" style="flex:0 0 220px; font-weight:600;">Request Type<span style="color:red;"> *</span></label>
      <select id="requestType" class="required" style="flex:1; padding:8px; border:1px solid #ccc; border-radius:4px;">
    ...
    <div id="platformContainer" style="margin-bottom:15px; display:none; display:flex; align-items:center;">
      <label for="platform" style="flex:0 0 220px; font-weight:600;">Platform<span style="color:red;"> *</span></label>
    ...
    <div id="productGroupContainer" style="margin-bottom:15px; display:none; display:flex; align-items:center;">
      <label for="productGroup" style="flex:0 0 220px; font-weight:600;">Product Group<span style="color:red;"> *</span></label>
